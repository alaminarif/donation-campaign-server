...
const getAllCampaign = (filter, paginationOptions) =>
  __awaiter(void 0, void 0, void 0, function* () {
    //
    ...
    const result = yield campaign_model_1.Campaign.find(whareConditions)
      ...
      .limit(limit)
      .sort(sortConditions);
    const total = yield campaign_model_1.Campaign.countDocuments(
      whareConditions
    );
    return {
      meta: {
...
const updateCampaign = (id, paylaoad) =>
  __awaiter(void 0, void 0, void 0, function* () {
    //
    const query = { _id: id };
    ...
    if (!isExist) {
      throw new AppError_1.default(
        ...
        "Campaign does't exist "
      );
    }
    const result = yield campaign_model_1.Campaign.findByIdAndUpdate(
      query,
      paylaoad,
      {
        new: true,
...
const deleteCampaign = id =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield campaign_model_1.Campaign.findByIdAndDelete({
      _id: id,
    });
    return result;
  });
