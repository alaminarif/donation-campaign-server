...
const getAllDonation = (filter, paginationOptions) => __awaiter(void 0, void 0, void 0, function* () {
    //
    ...
    const result = yield donation_model_1.Donation.find(whareConditions)
        ...
        .limit(limit)
        .sort(sortConditions);
    const total = yield donation_model_1.Donation.countDocuments(whareConditions);
    return {
        meta: {
            page,
            limit,
...
const getSingleDonation = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield donation_model_1.Donation.findById({ _id: id }).populate('user');
    return result;
});
const updateDonation = (id, paylaoad) => __awaiter(void 0, void 0, void 0, function* () {
    //
    const query = { user: id };
...
const deleteDonation = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield donation_model_1.Donation.findByIdAndDelete({ _id: id }).populate('user');
    return result;
});
