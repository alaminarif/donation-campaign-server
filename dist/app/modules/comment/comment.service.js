...
const createComment = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    const result = (yield comment_model_1.Comment.create(payload)).populate('user');
    return result;
});
const getAllComment = (paginationOptions) => __awaiter(void 0, void 0, void 0, function* () {
    //
...
const getMyComment = (id) => __awaiter(void 0, void 0, void 0, function* () {
    //
    const query = { user: id };
    ...
    const result = yield comment_model_1.Comment.findOne(query).populate('user');
    return result;
});
const updateComment = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield comment_model_1.Comment.findOneAndUpdate(query, payload, {
        new: true,
    }).populate('user');
    return result;
});
