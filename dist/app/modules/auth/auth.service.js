...
const loginUser = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const accessToken = jwtHelpers_1.jwtHelpers.createToken({ userEmail, role, _id }, config_1.default.jwt.secret, config_1.default.jwt.expires_in);
    const refreshToken = jwtHelpers_1.jwtHelpers.createToken({ userEmail, role, _id }, config_1.default.jwt.refresh_secret, config_1.default.jwt.refresh_expires_in);
...
const changePassword = (user, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const isUserExist = yield user_model_1.User.isUserExist(user === null || user === void 0 ? void 0 : user.userEmail);
    if (!isUserExist) {
        throw new ApiError_1.default(http_status_1.default.NOT_FOUND, 'User does not exist');
    }
    if (isUserExist.password &&
    ...
    const query = { email: user === null || user === void 0 ? void 0 : user.userEmail };
    const updatedData = {
