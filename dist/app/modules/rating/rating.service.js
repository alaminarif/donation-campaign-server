...
const getAllRating = (paginationOptions) => __awaiter(void 0, void 0, void 0, function* () {
    //
...
const getSingleRating = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield rating_model_1.Rating.findById({ _id: id }).populate('user');
    return result;
});
const updateRating = (id, paylaoad) => __awaiter(void 0, void 0, void 0, function* () {
    const query = { user: id };
    ...
    const result = yield rating_model_1.Rating.findByIdAndUpdate(query, paylaoad, {
        new: true,
    });
    return result;
});
