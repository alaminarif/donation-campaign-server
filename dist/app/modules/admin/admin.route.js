...
router.post(
  ...
  admin_controller_1.AdminController.changePassword
);
...
router.patch(
  '/my-profile',
  (0, validateRequest_1.default)(
    admin_validation_1.AdminValidation.updateProfileZodSchema
  ),
  (0, auth_1.default)(user_1.ENUM_USER_ROLE.ADMIN),
  admin_controller_1.AdminController.updateProfile
);
router.delete('/:id', admin_controller_1.AdminController.deleteAdminFromDB);
