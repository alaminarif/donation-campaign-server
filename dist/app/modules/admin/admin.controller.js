...
const changePassword = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield admin_service_1.AdminService.changePassword(Admin, passwordData);
    (0, sendResponse_1.default)(res, {
        success: true,
        statusCode: http_status_1.default.OK,
...
const getMyProfile = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    // paginationOptions
    const email = (_a = req.user) === null || _a === void 0 ? void 0 : _a.adminEmail;
    console.log(' : ', email);
...
const updateProfile = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _b;
    // paginationOptions
    const email = (_b = req.user) === null || _b === void 0 ? void 0 : _b.adminEmail;
    const updatedData = req.body;
    const result = yield admin_service_1.AdminService.updateProfile(email, updatedData);
    (0, sendResponse_1.default)(res, {
        success: true,
        statusCode: http_status_1.default.OK,
