...
const changePassword = (Admin, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { oldPassword } = payload;
    const isAdminExist = yield Admin === null || Admin === void 0
      ? void 0
      : Admin.findOne({
...
// auth part end
const getAllAdmin = (filter, paginationOptions) =>
  __awaiter(void 0, void 0, void 0, function* () {
    //
