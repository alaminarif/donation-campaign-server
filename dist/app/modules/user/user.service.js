...
const getAllUser = (filter, paginationOptions) => __awaiter(void 0, void 0, void 0, function* () {
    //
...
const updateProfile = (email, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield user_model_1.User.findOneAndUpdate({ email: email }, updatedUserData, {
        new: true,
    });
    return result;
});
