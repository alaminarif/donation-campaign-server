...
const getAllPayment = (filter, paginationOptions) => __awaiter(void 0, void 0, void 0, function* () {
    //
...
const updatePayment = (id, paylaoad) => __awaiter(void 0, void 0, void 0, function* () {
    //
    const query = { user: id };
    ...
    const result = yield payment_model_1.Payment.findByIdAndUpdate(query, paylaoad, {
        new: true,
    })
        .populate('user')
        .populate('donation');
